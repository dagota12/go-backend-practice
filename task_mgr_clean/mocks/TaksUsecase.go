...
// TaksUsecase is an autogenerated mock type for the TaksUsecase type
type TaksUsecase struct {
	mock.Mock
}

// CreateTask provides a mock function with given fields: task
func (_m *TaksUsecase) CreateTask(task domain.Task) (domain.Task, error) {
	ret := _m.Called(task)
...
func (_m *TaksUsecase) DeleteTask(id string) error {
	ret := _m.Called(id)
...
func (_m *TaksUsecase) GetTask(id string) (domain.Task, error) {
	ret := _m.Called(id)
...
func (_m *TaksUsecase) GetTasks() []domain.Task {
	ret := _m.Called()
...
func (_m *TaksUsecase) GetUserTasks(user_id string) []domain.Task {
...
func (_m *TaksUsecase) UpdateTask(id string, task domain.Task) (domain.Task, error) {
...
// NewTaksUsecase creates a new instance of TaksUsecase. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewTaksUsecase(t interface {
	mock.TestingT
	Cleanup(func())
}) *TaksUsecase {
	mock := &TaksUsecase{}
